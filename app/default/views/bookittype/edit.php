    ...
    <?php echo View::getMessage();  ?> 
        ...
        <input type="hidden" name="bookittypeid" value="<?php echo $bookittype->id; ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="list_title" class="form-control" placeholder="Page Heading"><?php echo $bookittype->list_title; ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Page Content</label>
                <div class="col-sm-10">
                    <textarea name="list_desc"><?php echo ($bookittype->list_desc) ? $bookittype->list_desc : ''; ?></textarea>
                    <script>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="page_title" class="form-control" placeholder="Page Title"><?php echo $bookittype->page_title; ?></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea name="page_desc" class="form-control" placeholder="Meta Description"><?php echo $bookittype->page_desc; ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Meta Key</label>
                <div class="col-sm-10">
                    <textarea name="page_key" class="form-control" placeholder="Meta Key"><?php echo $bookittype->page_key; ?></textarea>
                </div>
            </div>
