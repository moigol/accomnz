...
--
-- Host: localhost:3306
-- Generation Time: Apr 11, 2017 at 10:10 PM
...
-- Functions
--
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetAgency`(`GivenID` INT) RETURNS text CHARSET utf8
BEGIN
...
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetAgents`(`GivenID` INT) RETURNS text CHARSET latin1
BEGIN
...
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetAncestry`(`GivenID` INT) RETURNS varchar(1024) CHARSET utf8
BEGIN
    DECLARE rv VARCHAR(1024);
    DECLARE cm CHAR(1);
    DECLARE ch,ui INT;
...
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetChildrenByID`(`GivenID` INT) RETURNS text CHARSET latin1
BEGIN
    DECLARE rv,q,queue,queue_children TEXT;
    DECLARE queue_length,front_id,pos INT;
    SET rv = '';
...
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetParents`(`GivenID` INT) RETURNS text CHARSET utf8
BEGIN
    DECLARE rv VARCHAR(1024);
    DECLARE cm CHAR(1);
    DECLARE ch,ul,ui INT;
...
CREATE DEFINER=`gaskylight`@`localhost` FUNCTION `GetSale`(`GivenID` INT) RETURNS text CHARSET utf8
BEGIN
  DECLARE rv VARCHAR(1024); 
...
INSERT INTO `accounts` (`AccountID`, `UserID`, `AccessUserID`, `AccountMetaID`, `BankAccountID`, `AccountType`, `AccountTitle`, `AccountEmail`, `CommissionLevel`, `Commission`, `CommissionTwo`, `CompanyName`, `CompanyDocument`, `PhotoId`, `Agreement`, `BankAccountProof`, `RegistrationNo`, `RegistrationAddress`, `RegistrationCountry`, `RegistrationTelephone`, `BusinessAddress`, `BusinessCountry`, `ApplicationDate`, `AccountStatus`, `ProductID`, `ProductItemID`, `PaymentReceived`, `ReceivedAmount`, `OpeningFee`, `OpeningFeePromo`, `ManagementFee`, `ManagementFeeWaiver`, `CashAmount`, `CommencementDate`, `EmailSent`, `EmailSentBy`, `MaturityDate`, `ApprovedBy`, `ApprovedDate`, `DepositedAmount`, `TransactionDate`, `FormType`, `CourierStatus`, `Active`) VALUES
(10038, 100065, '100086', 10026, 46, 'Individual', '', '123@gmail.com', 1, '6', '12', '', '', '', '', '', '', '', 'China', '', '', 'Hong Kong', '2016-10-07 16:00:00', 'Approved', 210001, 10037, '2016-10-11', 30950, '1000', '', '2%', '', 950, '2016-10-10', '0000-00-00 00:00:00', 0, '2019-10-09', 'LAI YUN TZU', '2016-10-08', 30000, '2016-10-11', 'Simplified', '', 1),
(10048, 100078, '100086', 10036, 59, 'Corporate', '', 'opopo@gmail.com', 1, '6', '12', 'Sun Ying Enterprise Management Consulting Co.Ltd', '', '', '', '', '54093933', '彰化縣和美鎮和光路250號1樓', 'Taiwan', '04-24524777', '', 'Taiwan', '2016-10-25 16:00:00', 'Approved', 210001, 10037, '2016-10-26', 21270, '', '', '', '', 1270, '2016-10-31', '0000-00-00 00:00:00', 0, '2018-10-30', 'Vicky ', '2016-10-26', 20000, '0000-00-00', 'Traditional', '', 1),
(10050, 100033, '', 0, 61, 'Individual', '', 'kid720401@gmail.com', 1, '6', '12', '', '', '', '', '', '', '', '', '', '', '', '2016-11-22 09:54:09', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10053, 100084, '', 0, 65, 'Individual', '', 'odeon@odeonco.com', 1, '10', '12', 'Global Assets Inc. Ltd.', '', '', '', '', '', '', '', '', '', '', '2016-12-07 07:29:22', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10054, 100081, '', 0, 68, 'Individual', '', 'Hao@gmail.com', 2, '7', '12', '', '', '', '', '', '', '', '', '', '', '', '2016-12-07 07:33:10', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10055, 100001, '', 0, 0, 'Individual', '', 'trust@odeonco.com', 1, '7', '12', 'Odeon & Co', '', '', '', '', '', '', '', '', '', '', '2016-12-09 09:19:36', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10056, 100085, '', 0, 71, 'Individual', '', 'support@appextended.com', 1, '7', '12', 'AppExtended Inc', '2710', '', '', '', '', '', '', '', '', '', '2016-12-09 14:01:33', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10057, 100086, '', 0, 74, 'Individual', '', 'ryanbang@banginc.com', 1, '7', '12', 'Bang Inc', '2713', '', '', '', '', '', '', '', '', '', '2016-12-09 14:21:59', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10063, 100098, '', 0, 80, 'Individual', '', 'abc@abc.com', 1, '7', '12', 'Testing Corp', '3538', '', '', '', '', '', '', '', '', '', '2016-12-14 04:44:12', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10064, 100099, '', 10042, 81, 'Individual', '', 'chowlyechoo@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Malaysia', '2016-12-20 05:52:02', 'Pending', 210001, 10029, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', 'Joanna Chow', '2016-12-20', 1000000, '0000-00-00', 'Traditional', '', 0),
(10065, 100105, '', 10043, 82, 'Individual', '', 'ryandumajil@gmail.com', 2, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'China', '2015-12-31 16:00:00', 'Approved', 210001, 10038, '2016-12-17', 0, '', '', '', '', 0, '2017-02-27', '2017-02-07 16:05:48', 100000, '2020-02-26', 'dfgdfg', '2017-01-23', 500000, '0000-00-00', 'Traditional', 'Waiting', 1),
(10066, 100107, '', 0, 83, 'Individual', '', 'abc@123.com', 1, '6', '12', '', '', '3732', '', '', '', '', '', '', '', '', '2017-02-13 00:04:32', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10067, 100108, '', 0, 84, 'Individual', '', 'abc@qwe.com', 2, '7', '12', 'Singapore', '3735', '', '', '', '', '', '', '', '', '', '2017-02-13 01:46:50', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10068, 100110, '', 0, 85, 'Individual', '', 'jeff@attrust.com', 1, '6', '12', 'Jeffro Pte Ltd', '3749', '', '', '', '', '', '', '', '', '', '2017-02-21 09:32:06', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10069, 100111, '', 0, 86, 'Individual', '', 'weh@weah.com', 3, '8', '12', '', '', '3750', '', '', '', '', '', '', '', '', '2017-02-21 09:42:12', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10070, 100112, '100085', 10044, 87, 'Individual', '', 'diao@diaoni.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Taiwan', '2017-02-21 16:00:00', 'Approved', 210001, 10037, '2017-02-24', 60354, '1000', '500', '2%', '1%', 0, '2017-02-27', '0000-00-00 00:00:00', 0, '2020-02-26', '', '2017-02-22', 60000, '0000-00-00', 'Traditional', '', 1),
(10071, 100113, '', 0, 88, 'Individual', '', '', 1, '7', '12', 'The Corp Agency', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:20:55', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10072, 100114, '', 0, 89, 'Individual', '', '', 3, '10', '12', '', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:26:02', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10073, 100115, '', 0, 90, 'Individual', '', '', 2, '9', '12', '', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:26:54', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10074, 100116, '', 0, 91, 'Individual', '', '', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:27:37', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10075, 100117, '', 0, 92, 'Individual', '', '', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:28:10', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10076, 100118, '', 0, 93, 'Individual', '', '', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', '', '2017-03-02 04:28:35', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10077, 100122, '', 10045, 94, 'Individual', '', 'shanying_yap@hotmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Hong Kong', '2017-03-10 04:54:22', 'Approved', 210001, 10037, '0000-00-00', 0, '', '', '', '', 0, '2017-03-20', '0000-00-00 00:00:00', 0, '2020-03-19', '', '1970-01-01', 30000, '0000-00-00', 'Traditional', '', 1),
(10078, 100123, '', 10046, 95, 'Individual', '', 'shanying_yap@hotmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Hong Kong', '2017-03-09 16:00:00', 'Approved', 210001, 10037, '0000-00-00', 0, '', '', '', '', 0, '2017-03-20', '0000-00-00 00:00:00', 0, '2020-03-19', '', '2017-03-10', 90000, '0000-00-00', 'Traditional', '', 1),
(10079, 100124, '', 10047, 96, 'Corporate', '', 'shanying_yap@hotmail.com', 1, '7', '12', 'AT Company', '', '', '', '', '505-101-303879', 'Hong Kong', 'Hong Kong', '23416622', '', 'Hong Kong', '2017-03-10 05:41:08', 'Approved', 210002, 10042, '0000-00-00', 0, '', '', '', '', 0, '2017-03-20', '0000-00-00 00:00:00', 0, '2020-03-19', '', '2017-03-10', 1000000, '0000-00-00', 'Traditional', '', 1),
(10080, 100125, '', 10048, 97, 'Individual', '', 'chrischuasg@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Hong Kong', '2017-03-31 16:00:00', 'Approved', 210002, 10042, '2017-04-03', 653123, '1000', '500', '2%', '2%', 0, '2017-04-03', '2017-04-01 03:47:27', 100079, '2022-04-02', 'asdfdasf', '2017-04-01', 650000, '0000-00-00', 'Traditional', '', 1),
(10081, 100126, '', 10049, 98, 'Individual', '', 'ryandsdsdsaumajil@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', 'China', '2017-03-31 19:10:02', 'Pending', 210001, 10038, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '1970-01-01', 100000, '0000-00-00', 'Traditional', '', 1),
(10082, 100127, '', 10050, 99, 'Individual', '', 'hffghvx@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', 'Philippines', '2017-04-01 11:55:53', 'Pending', 210001, 10038, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '1970-01-01', 100000, '0000-00-00', 'Traditional', '', 1),
(10083, 100128, '', 10051, 100, 'Individual', '', 'hffghvx@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'Philippines', '2017-04-01 12:05:06', 'Approved', 210001, 10039, '2017-04-04', 102000, '1000', '1000', '2', '2', 0, '2017-04-03', '0000-00-00 00:00:00', 0, '2020-04-02', '', '1970-01-01', 100000, '0000-00-00', 'Traditional', '', 1),
(10084, 100129, '', 0, 101, 'Individual', '', '', 1, '12', '12', 'the pong kwayla', '4013', '', '', '', '', '', '', '', '', '', '2017-04-03 08:47:37', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10085, 100130, '', 0, 102, 'Individual', '', '', 1, '7', '12', '', '', '4014', '', '', '', '', '', '', '', '', '2017-04-03 08:50:02', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10086, 100131, '100085', 10052, 103, 'Individual', '', 'smileatchris@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', 'China', '', '', 'China', '2017-04-02 16:00:00', 'Approved', 210002, 10041, '2017-04-04', 620100, '2000', '500', '2', '0', 0, '2017-04-10', '2017-04-03 09:30:43', 100079, '2022-04-09', 'JEFF', '2017-04-03', 620000, '0000-00-00', 'Traditional', '', 1),
(10087, 100132, '', 10053, 104, 'Individual', '', 'dstrout111@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', 'China', '2017-04-03 13:28:00', 'Approved', 210002, 10042, '2017-04-03', 250000, '2000', '', '', '', 0, '2017-04-10', '2017-04-03 14:08:24', 100086, '2022-04-09', 'dasdasdas asdasdas', '2017-04-03', 500000, '0000-00-00', 'Traditional', '', 1),
(10088, 100133, '', 10054, 105, 'Individual', '', 'ryasdsssadsdanajsd@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', 'China', '2017-04-04 15:17:50', 'Approved', 210002, 10042, '0000-00-00', 0, '', '', '', '', 0, '2017-04-10', '2017-04-05 06:16:06', 100086, '2022-04-09', 'dsadas', '2017-04-04', 500000, '0000-00-00', 'Traditional', '', 1),
(10089, 100134, '', 0, 106, 'Individual', '', '', 1, '12', '12', 'da pong kwaylaaaaa', '4087', '', '', '', '', '', '', '', '', '', '2017-04-06 06:52:29', 'Pending', 0, 0, '0000-00-00', 0, '', '', '', '', 0, '0000-00-00', '0000-00-00 00:00:00', 0, '0000-00-00', '', '0000-00-00', 0, '0000-00-00', 'Traditional', '', 0),
(10090, 100135, '', 10055, 107, 'Individual', '', 'champagne241@gmail.com', 1, '7', '12', '', '', '', '', '', '', '', '', '', '', 'China', '2017-04-06 07:06:02', 'Approved', 210002, 10041, '0000-00-00', 0, '', '', '', '', 0, '2017-04-10', '2017-04-10 14:03:17', 100086, '2020-04-09', 'oifdygjdsfggf', '2017-04-06', 500000, '0000-00-00', 'Traditional', 'Processing', 1);
...
(1, 10080, 100125, '', '', '', '', '', '', ''),
(2, 10080, 100125, '', '', '', '', '', '', ''),
(3, 10081, 100126, 'sadasdasd', 'adsdasd', '23232', 'dasdasdsada@gmail.com', 'dsadsa', 'dasdas', '23'),
(4, 10081, 100126, '', '', '', '', '', '', ''),
(5, 10082, 100127, 'Fhgdgh', 'Vgyhfvn', '24566', 'Gffgf@gmail.com', 'Ryjfv', '', '2'),
(6, 10082, 100127, '', '', '', '', '', '', ''),
(7, 10083, 100128, 'Fhgdgh', 'Vgyhfvn', '24566', 'Gffgf@gmail.com', 'Ryjfv', '', '2'),
(8, 10083, 100128, '', '', '', '', '', '', ''),
(9, 10086, 100131, '', '', '', '', '', '', ''),
(10, 10086, 100131, '', '', '', '', '', '', ''),
(11, 10087, 100132, 'dasdasdasdad', 'sadasdas', '123123', 'asdasdaddad@gmail.com', 'asdasd', 'dasda', '23'),
(12, 10087, 100132, 'sdadsadasdas', 'asdasdasd', '2312312', 'dsadasda@gmail.com', 'asdasda', 'sadasd', '3'),
(13, 10088, 100133, 'sdadsadasd', 'asdasdas', '23232', 'asdasdasdad@gmail.com', 'asdasda', 'sdasda', '19'),
(14, 10088, 100133, '', '', '', '', '', '', ''),
(15, 10090, 100135, 'qwehghdgfdg', 'dasdasdadfsdfsd', '1321321', 'asdadaasdasdad@gmail.com', 'asdasdasdasda', 'dasdasdasda', '50'),
(16, 10090, 100135, '', '', '', '', '', '', '');
...
(307, '2017-04-09 23:27:56', 'Sent commencement email letter for casefile #GA-CF-10086.', 100000, 'Moises Goloyugo'),
(308, '2017-04-10 04:37:38', 'Updated Role #4.', 100086, 'Ryan Dumajil'),
(309, '2017-04-10 13:44:17', 'Updated User #100086.', 100086, 'Ryan Dumajil'),
(310, '2017-04-10 14:03:17', 'Sent client commencement letter with casefile #GA-CF-10090.', 100086, 'Ryan Dumajil'),
(311, '2017-04-10 14:03:17', 'Sent commencement email letter for casefile #GA-CF-10090.', 100086, 'Ryan Dumajil'),
(312, '2017-04-12 01:52:45', 'Added Media File.', 100000, 'Moises Goloyugo'),
(313, '2017-04-12 03:48:06', 'Added Media File.', 100000, 'Moises Goloyugo'),
(314, '2017-04-12 03:52:17', 'Updated File #4105.', 100000, 'Moises Goloyugo'),
(315, '2017-04-12 03:54:48', 'Updated File #4105.', 100000, 'Moises Goloyugo'),
(316, '2017-04-12 04:09:59', 'Updated File #4105.', 100000, 'Moises Goloyugo'),
(317, '2017-04-12 05:06:15', 'Updated File #4104.', 100000, 'Moises Goloyugo'),
(318, '2017-04-12 05:08:09', 'Updated File #3799.', 100000, 'Moises Goloyugo'),
(319, '2017-04-12 05:08:16', 'Updated File #4100.', 100000, 'Moises Goloyugo');
...
CREATE TABLE IF NOT EXISTS `commission_overriding` (
...
CREATE TABLE IF NOT EXISTS `commission_personal` (
...
INSERT INTO `files` (`FileID`, `UserID`, `FileCategoryID`, `FileAccess`, `DateAdded`) VALUES
(175, 100047, 0, '', '2016-09-05 11:27:11'),
(202, 100048, 0, '', '2016-09-05 12:02:30'),
(233, 100049, 0, '', '2016-09-05 12:26:25'),
(696, 100049, 0, '', '2016-09-06 10:48:17'),
(751, 100001, 0, '', '2016-09-08 09:13:04'),
(786, 100052, 0, '', '2016-09-23 07:31:13'),
(817, 100053, 0, '', '2016-09-23 09:07:21'),
(848, 100054, 0, '', '2016-09-24 07:14:23'),
(1477, 100060, 0, '', '2016-09-28 06:42:55'),
(1588, 100065, 0, '', '2016-10-08 06:30:03'),
(1589, 100065, 0, '', '2016-10-08 06:30:03'),
(1590, 100065, 0, '', '2016-10-08 06:30:03'),
(1591, 100065, 0, '', '2016-10-08 06:30:03'),
(1592, 100065, 0, '', '2016-10-08 06:30:03'),
(1593, 100065, 0, '', '2016-10-08 06:30:03'),
(1618, 100066, 0, '', '2016-10-10 03:56:00'),
(1622, 100066, 0, '', '2016-10-10 03:56:00'),
(1648, 100067, 0, '', '2016-10-10 05:17:28'),
(1657, 100067, 0, '', '2016-10-10 05:17:28'),
(1658, 100067, 0, '', '2016-10-10 05:17:28'),
(1659, 100067, 0, '', '2016-10-10 05:17:28'),
(2056, 100071, 0, '', '2016-10-24 06:42:21'),
(2060, 100071, 0, '', '2016-10-24 06:42:21'),
(2063, 100071, 0, '', '2016-10-24 06:42:21'),
(2078, 100071, 0, '', '2016-10-24 06:42:21'),
(2127, 100072, 0, '', '2016-10-24 08:45:53'),
(2311, 100078, 0, '', '2016-10-26 04:52:29'),
(2312, 100078, 0, '', '2016-10-26 04:52:29'),
(2315, 100078, 0, '', '2016-10-26 04:52:29'),
(2325, 100078, 0, '', '2016-10-26 04:52:29'),
(2328, 100078, 0, '', '2016-10-26 04:52:29'),
(2332, 100078, 0, '', '2016-10-26 04:52:29'),
(2333, 100078, 0, '', '2016-10-26 04:52:29'),
(2338, 100078, 0, '', '2016-10-26 04:52:29'),
(2396, 100078, 0, '', '2016-10-27 05:37:45'),
(2400, 100078, 0, '', '2016-10-27 05:37:45'),
(2407, 100079, 0, '', '2016-10-27 07:23:28'),
(2408, 100079, 0, '', '2016-10-27 07:23:28'),
(2411, 100079, 0, '', '2016-10-27 07:23:28'),
(2415, 100079, 0, '', '2016-10-27 07:23:29'),
(2421, 100079, 0, '', '2016-10-27 07:23:32'),
(2424, 100079, 0, '', '2016-10-27 07:23:33'),
(2425, 100079, 0, '', '2016-10-27 07:23:33'),
(2427, 100079, 0, '', '2016-10-27 07:23:33'),
(2428, 100079, 0, '', '2016-10-27 07:23:33'),
(2429, 100079, 0, '', '2016-10-27 07:23:33'),
(2430, 100079, 0, '', '2016-10-27 07:23:33'),
(2434, 100079, 0, '', '2016-10-27 07:23:34'),
(2435, 100079, 0, '', '2016-10-27 07:23:34'),
(2437, 100079, 0, '', '2016-10-27 07:23:34'),
(2438, 100080, 0, '', '2016-10-27 07:23:36'),
(2439, 100080, 0, '', '2016-10-27 07:23:36'),
(2442, 100080, 0, '', '2016-10-27 07:23:36'),
(2446, 100080, 0, '', '2016-10-27 07:23:37'),
(2452, 100080, 0, '', '2016-10-27 07:23:43'),
(2455, 100080, 0, '', '2016-10-27 07:23:43'),
(2456, 100080, 0, '', '2016-10-27 07:23:43'),
(2458, 100080, 0, '', '2016-10-27 07:23:44'),
(2459, 100080, 0, '', '2016-10-27 07:23:44'),
(4088, 100135, 0, '', '2017-04-06 07:06:02'),
(4089, 100135, 0, '', '2017-04-06 07:06:02'),
(4090, 100135, 0, '', '2017-04-06 07:06:02'),
(4091, 100135, 0, '', '2017-04-06 07:06:02'),
(4092, 100135, 0, '', '2017-04-06 07:06:02'),
(4099, 100135, 0, '', '2017-04-06 07:06:02'),
(4100, 100086, 3, 'YToxOntpOjA7czo2OiIxMDAxMDgiO30=', '2017-04-06 07:45:24'),
(4104, 100000, 3, 'YToxOntpOjA7czo2OiIxMDAwODQiO30=', '2017-04-11 18:52:44'),
(4105, 100000, 3, 'YToxOntpOjA7czo2OiIxMDAwODQiO30=', '2017-04-11 20:48:06');
...
`FileCategoryID` int(21) NOT NULL,
  `FileCategoryName` varchar(255) NOT NULL,
  `FileCategoryDescription` varchar(255) NOT NULL
...
(311, 100000, 4104, 'whatever here is better', 'whateverhereisbetter_r.png', '用于营销的新文件', 'C:\\Bitnami\\wamp\\apache2\\htdocs\\globalassetinc\\app\\globalassets\\views\\assets\\files\\downloads\\2017\\04\\11\\whateverhereisbetter_r.png', '/2017/04/11/whateverhereisbetter_r.png', 0),
(312, 100000, 4105, 'test', 'test_r.png', 'test', 'C:\\Bitnami\\wamp\\apache2\\htdocs\\globalassetinc\\app\\globalassets\\views\\assets\\files\\downloads\\2017\\04\\11\\test_r.png', '/2017/04/11/test_r.png', 0);
...
`ProductID` int(21) NOT NULL,
  ...
  `ProductEmailTemplate` varchar(255) NOT NULL,
  `Active` int(11) NOT NULL DEFAULT '1'
) ENGINE=MyISAM AUTO_INCREMENT=210009 DEFAULT CHARSET=latin1;
...
`ProductItemID` int(21) NOT NULL,
  ...
  `ProductItemTitle` varchar(512) NOT NULL,
  `CouponAmount` text NOT NULL,
  ...
  `Active` int(11) NOT NULL DEFAULT '1'
) ENGINE=MyISAM AUTO_INCREMENT=10048 DEFAULT CHARSET=latin1;
...
`UserID` int(21) NOT NULL,
  ...
  `Active` int(1) NOT NULL DEFAULT '0',
  `DateAdded` datetime NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=100136 DEFAULT CHARSET=utf8;
...
ALTER TABLE `account_meta`
 ADD PRIMARY KEY (`AccountMetaID`), ADD KEY `CaseFileID` (`AccountMetaID`), ADD KEY `CaseFileID_2` (`AccountMetaID`);
...
ALTER TABLE `bank_accounts`
 ADD PRIMARY KEY (`BankAccountID`), ADD UNIQUE KEY `UserID` (`UserID`), ADD KEY `BankAccountID` (`BankAccountID`), ADD KEY `BankAccountID_2` (`BankAccountID`);
...
ALTER TABLE `commission_scheme`
 ADD PRIMARY KEY (`SchemeID`), ADD UNIQUE KEY `UserID` (`UserID`), ADD KEY `SchemeID` (`SchemeID`);
...
ALTER TABLE `email_queue`
 ADD PRIMARY KEY (`EmailQueueID`), ADD KEY `EmailQueueID` (`EmailQueueID`);
...
--
ALTER TABLE `activity_logs`
MODIFY `ActivityID` int(21) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=320;
--
...
--
ALTER TABLE `files`
MODIFY `FileID` int(21) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4106;
--
...
--
ALTER TABLE `file_items`
MODIFY `FileItemID` int(21) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=313;
--
